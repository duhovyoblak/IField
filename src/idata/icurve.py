...
_AXES  = {'x': 'Os X', 'y': 'Os Y'}       # Default axes
_VALS  = {'v': 'Value'            }       # Default values
...
#------------------------------------------------------------------------------
print(f"ICurve ver {_VER}")

if __name__ == '__main__':

    logger.info("Testing ICurve class")

    #--------------------------------------------------------------------------
    # Test of the ICurve class
    #--------------------------------------------------------------------------
    imat = ICurve(name='imatTest')
